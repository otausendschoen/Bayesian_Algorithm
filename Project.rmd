...
Finally, we compare the hybrid model’s continuous component to those from the baseline dense model. 
```{r}
...
```{r}
#print(fit_XYZ, pars = c("beta", "mu_alpha", "tau", "sigma"), probs = c(0.025, 0.5, 0.975))
```

.....

Some discussion about everything we have done.
